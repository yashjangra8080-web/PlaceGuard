...
export default function CodingTestPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setMsg({
        type: 'info',
        text: 'Submission recorded. Judge0 execution is pending configuration — your code is saved and will be evaluated once the execution engine is enabled.',
      })
    } catch (e) {
        ...
        <div className="coding-editor-area">
          <div className="coding-editor-bar">
            <span style={{ fontSize: 12, color: 'var(--text-secondary)' }}>
              Solution &mdash; {LANG_LABELS[lang] ?? lang}
              {alreadySubmitted && <span style={{ marginLeft: 8, color: 'var(--warning)', fontWeight: 600 }}> &middot; submitted (read-only)</span>}
            </span>
          </div>
          <div className="code-editor-wrap">
            <textarea
              ...
              value={code}
              onChange={e => { if (!alreadySubmitted) setCode(e.target.value) }}
